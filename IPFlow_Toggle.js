	...
	for(var a = 0; a < json.length ; a++){
		...
		//	browser.driver.sleep(6000);
			...
			element(by.cssContainingText('span.clearfloat','4567')).element(by.xpath('/html/body/div[3]/div[1]/div[17]/div/div/table[4]/tbody/tr[1]/td[1]/div[1]/img')).click();
			jasmine.DEFAULT_TIMEOUT_INTERVAL = 600000;
			browser.sleep(10000);
			...
			element(by.xpath('/html/body/div[3]/div[26]/div/div/div[2]/div/table/tbody/tr[1]/td')).click();
			...
			element(by.id('focusedInput')).sendKeys('TIVICAY FC ').sendKeys(protractor.Key.ENTER);
			//browser.actions().sendKeys(protractor.Key.ENTER).perform();
			//element(by.xpath('/html/body/div[3]/div[1]/div[2]/div[1]/div/div/div[2]/div/div/div[2]/div[1]/div/div/div/div[1]/div[2]/div[2]/div/div[1]/form/div/div[2]/div[1]/div/div/ul/li/a/strong')).click();
			jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
			browser.sleep(10000);
			
			//Mention the Frequency of the Medicine
			element(by.name('schedule')).sendKeys('2 Times Daily').sendKeys(protractor.Key.ENTER);
		//	element(by.xpath('/html/body/div[3]/div[1]/div[2]/div[1]/div/div/div[2]/div/div/div[2]/div[1]/div/div/div/div[1]/div[2]/div[2]/div/div[1]/form/div/div[3]/div[1]/ul/li[1]/a/strong')).click();
			jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
			browser.sleep(10000);
			
			
			//Mention the Dosage of the Medicine (Mentioned medicine name has already dosage )
			...
			element(by.xpath('/html/body/div[3]/div[1]/div[2]/div[1]/div/div/div[2]/div/div/div[2]/div[1]/div/div/div/div[1]/div[2]/div[2]/div/div[1]/form/div/div[3]/div[3]/div/input')).sendKeys('1');
			jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
			browser.sleep(10000);
			
			//Turining On the Toggle Button
			element(by.xpath('/html/body/div[3]/div[1]/div[2]/div[1]/div/div/div[2]/div/div/div[2]/div[1]/div/div/div/div[1]/div[2]/div[2]/div/div[1]/form/div/div[5]/div[3]/div[1]/div/md-switch/div[1]/div[2]/div')).click();
			jasmine.DEFAULT_TIMEOUT_INTERVAL = 100000;
			browser.sleep(10000);
